...
The simplification compared to the exemplar in
`labs/Lab02-Solution-Exemplar.md`: instead of using
`createCookieSessionStorage` to wrap the backend's JWT in a second cookie,
